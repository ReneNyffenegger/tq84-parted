...
ACLOCAL = ${SHELL} /var/tmp/tq84-parted/build-aux/missing --run aclocal-1.11a
ALLOCA = 
ALLOCA_H = alloca.h
AMTAR = $${TAR-tar}
...
AR = ar
ARFLAGS = cru
AUTOCONF = ${SHELL} /var/tmp/tq84-parted/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /var/tmp/tq84-parted/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /var/tmp/tq84-parted/build-aux/missing --run automake-1.11a
AWK = gawk
BITSIZEOF_PTRDIFF_T = 
...
BITSIZEOF_WCHAR_T = 
BITSIZEOF_WINT_T = 
BUILDINFO = rene@T420, 06 Jan 2019 20:31
CC = gcc
...
LT_AGE = 0
LT_CURRENT = 0
LT_RELEASE = UNKNOWN.UNKNOWN
LT_REVISION = 0
MAKEINFO = ${SHELL} /var/tmp/tq84-parted/build-aux/missing --run makeinfo
MANIFEST_TOOL = :
...
YIELD_LIB = -lrt
abs_aux_dir = /var/tmp/tq84-parted/build-aux
abs_builddir = /var/tmp/tq84-parted
abs_srcdir = /var/tmp/tq84-parted
abs_top_builddir = /var/tmp/tq84-parted
abs_top_srcdir = /var/tmp/tq84-parted
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /var/tmp/tq84-parted/build-aux/install-sh
